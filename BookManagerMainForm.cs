...
namespace BookManagement_HoangNgocTrinh
{
    public partial class BookManagerMainForm : Form
    {
        ...
        private void FillDataGridView()
        {
            ...
            dgvBookList.DataSource = _service.GetAllBooks(); //nhờ Service xuống DB
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            //ko thoát hàm tức là đã chọn dòng 
            //nhờ Service xoá giùm 

            //TRƯỚC KHI XOÁ HỎI CÂU CONFIRM
            ...
            //sure Yes thì xoá
            _service.DeleteBookFromUI(_selected); //thay vì đẩy cuốn sách Book sang Detail form nay ta đẩy xuống hàm xoá 
            //F5 grid
            FillDataGridView();
